...
survModel_IncrCumInc_addConstr = function(fitCoxCause1,fitCoxCause2,fitlme,Lbeta = fixed.effects(fitlme),reffects = as.matrix(ranef(fitlme)),
                                          nknotsCause1 = 4,nknotsCause2 = 4,timeVar = "times",alpha1 = 1,alpha2 = 1,
                                          ...
                                          useGauleg = F,Gauleg_points = 30)
{
  ...
  fsurvDer = function(paramSurv)
  {
    ...
    score1 = .colSums(deltaCause1*xCause1Comb,nCause1,lpCause1,F) - (1+alpha1)*.colSums( deltaCause1Long*(qq1Mat*aa1),nLong,lpCause1,F) 
    score1 = score1 - .colSums( (1 - deltaLong)*(qq1Mat*tt1),nLong,lpCause1,F)
    
    score2 = .colSums(deltaCause2*xCause2Comb,nCause1,lpCause2,F) - (1+alpha2)*.colSums( deltaCause2Long*(qq2Mat*aa2),nLong,lpCause2,F) 
